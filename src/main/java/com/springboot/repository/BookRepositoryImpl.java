...
public class BookRepositoryImpl implements BookRepository {
	...
	public BookRepositoryImpl() {
		...
		book1.setAuthor("조현영");
		book1.setDescription("자바스크립트의 기초부터 심화까지 핵심 문법을 학습한 후 12가지 프로그램을 만들며 " + "학습한 내용을 확인할 수 있습니다. "
		...
		book2.setDescription("4차 산업혁명의 핵심인 러신머닝, 사물 인터넷(IoT), 데이터 분석등" + "다양한 분야에 활용되는 직관적이고간결한 문법의 파이썬 프로그래밍 언어를"
				+ "최신 트렌드에 맞게 예제 중심으로 학습 할 수 있습니다.");
		...
		book3.setDescription("안드로이드의 기본 개념을 체계적으로 익히고, 이를 실습 예제를 통해 익힙니다. "
				+ "기본 개념과 사용법을 스스로 실전에 적용하는 방법을 학습한 다음 실습 에제와 응용 " + "예제를 통해 실전 프로젝트 응용력을 키웁니다.");
